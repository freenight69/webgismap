<template>
    <div class="maptools-view">
        <el-button id="xzqh" class="maptools-item" size="medium" @click="handleMapToolsItemClick">行政导航</el-button>
        <el-button id="maptree" class="maptools-item" style="margin-left:5px" size="medium" @click="handleMapToolsItemClick">图层管理</el-button>
        <el-dropdown class="maptools-item" @command="handleCommand">
            <el-button class="maptools-item" size="medium">
        ...
        <el-button id="clear" class="maptools-item" size="medium" @click="handleMapToolsItemClick">清屏</el-button>
    </div>
</template>
